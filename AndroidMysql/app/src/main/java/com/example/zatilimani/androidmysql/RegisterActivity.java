...
public class RegisterActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        inputFullName = (EditText) findViewById(R.id.devicename);
        ...
        btnRegister.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                String devicename = inputFullName.getText().toString().trim();
                String email = inputEmail.getText().toString().trim();
                String password = inputPassword.getText().toString().trim();

                if (!devicename.isEmpty() && !email.isEmpty() && !password.isEmpty()) {
                    registerUser(devicename, email, password);
                } else {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (!error) {
                        ...
                        String email = device.getString("email");
                        String created_at = device
                                .getString("created_at");

                        // Inserting row in users table
                        db.addDevice(devicename, email, uid, created_at);

                        Toast.makeText(getApplicationContext(), "Device successfully registered. Try login now!", Toast.LENGTH_LONG).show();
